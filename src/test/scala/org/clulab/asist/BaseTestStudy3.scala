...
class BaseTestStudy3 extends FlatSpec with Matchers {

  val extractor = BaseTestStudy3.extractor
...
object BaseTestStudy3 {
  val extractor = new TomcatRuleEngine(rulepath = Some("/org/clulab/asist/study3_study2/master.yml"));
}
