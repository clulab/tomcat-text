...
class ActionAnnotation(var span: String, var start_offset: Int,
                       ...
                       var id: String, var target_span: String = "-1",
                       var target_id: String = "-1", val factual: Boolean) {
  ...
  def deepCompare(other_type: String, other_start: Int, other_end: Int,
                  other_target: Option[String] = None): Boolean ={
...
class EntityAnnotation(var span: String, var start_offset: Int,
                       var end_offset: Int, var id: String){
