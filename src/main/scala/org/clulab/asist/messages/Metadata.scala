...
case class MetadataData(
  ...
  // From Chat metadata
  val sender: String = "", // "player_1"

  // From University of Arizona ASR metadata
  val participant_id: String = "", // "player_1"
  val id: String = "",

  // From Aptima ASR metadata
  val playername: String = "", // "player_1"

  // From all metadata
  val text: String = "" // "You want me to share my screen?"
)
...
case class MetadataMsg (
  ...
  val replay_root_id: String = "", // "123e4567-e89b-12d3-a456-426655440000"
  val replay_id: String = "" // "876e4567-ab65-cfe7-b208-426305dc1234"
)
