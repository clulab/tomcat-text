...
/** support production of heartbeat and VersionInfo messages */
class MqttAgentTrial(
  ...
  override def pubTopic = "TrialPubTopic"
...
class MqttAgentChat(
  ...
  override def pubTopic = "ChatPubTopic"
...
class MqttAgentSpeech(
  ...
  override def pubTopic = "SpeechPubTopic"
...
class MqttAgentIdc(
  ...
  override def pubTopic = "IdcPubTopic"
