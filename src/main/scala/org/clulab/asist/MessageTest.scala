...
trait MessageTest {
   ...
   *  @param key the name of the structure parameter
   *  @param a a value for the key 
   *  @param b a value for the key 
...
/** Compare two DialigAgentMessage structures */
object MessageTestDialogAgent extends MessageTest {

  /** Compare two DialogAgentMessage structures 
   *  @param a data for comparison
   *  @param b data for comparison
   ...
   *  @param a data sequence for comparison
   *  @param b data sequence for comparison
   ...
   *  @param i zero-based sequence index 
   *  @param a key-value pair sequence for comparison
   *  @param b key-value pair sequence for comparison
   *  @param l list of results of comparisons
   *  @return true if a and b are identical
   */
  def taxonomyMatches(
   ...
   *  @param i zero-based sequence index 
   *  @param a key-value pair for comparison
   *  @param b key-value pair for comparison
   *  @return true if a and b are identical
   */
  def taxonomyMatch(i: Int, a:(String, String), b:(String, String)): Boolean = 
    test("        %d".format(i),"%s".format(a),"%s".format(b))
}
