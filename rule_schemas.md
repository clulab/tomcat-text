...
-----  |   ---- 
type |  GraphExtractor
labels    | [`Remove`, `SimpleAction`, `Action`, `EventLike`, `Concept`]
priority  | `(8-9)`
keep      | `true`
...
#### rule: _area_with_argument_beacon_
...
#### rule: _area_with_argument_flag_
